...
export class DashboardComponent implements OnInit {
  ...
  lineChartData: ChartDataSets[] = [
    { data: [], label: 'Giá trị sản phẩm tồn ', backgroundColor: 'rgb(0,0,255)',borderWidth:0.2 },
    { data: [], label: 'Giá trị sản phẩm bán ra ', backgroundColor: 'rgb(250,255,65)',borderWidth:0.2 },
  ];
  ...
  getTopDataSetBanRaTonKho() {
    this.service.getTopDataSetBanRaTonKho().subscribe(
      result => {
        ...
        console.log("tồn",this.datasetbanratonkho)

...
namespace API.Data
{
    public class DPContext : IdentityDbContext
    {
        ...
        public DbSet<SanPhamKho> SanPhamKho { get; set; }
        public DbSet<PhieuHoanHang> PhieuHoanHang { get; set; }
        public DbSet<ChiTietPhieuHoanHang> ChiTietPhieuHoanHang { get; set; }
        public DbSet<CTKMs> CTKMs { get; set; }
        public DbSet<SanPhamCTKM> SanPhamCTKM { get; set; }

...
namespace API.Controllers
{
    ...
    public class EmailController : Controller
    {
        ...
        public EmailController(IOptions<SmtpSettings> smtpSettings, DPContext context)
        {
        ...
        public async Task<ActionResult<string>> sendemail([FromForm] EmailRequest upload)
        {
            try
            {
                ...
                if (await _context.AppUsers.FirstOrDefaultAsync(u => u.Email == upload.To) == null)
                {
                    return Conflict(new { Message = "Email chưa có tài khoản." });
                }

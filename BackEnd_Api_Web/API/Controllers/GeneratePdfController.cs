        ...
        public async Task<IActionResult> GetAllOrder()
        {
            var kb = from hd in _context.HoaDons
                     ...
                     select new HoaDonUser()
                     {
                         ...
                         LoaiThanhToan = hd.LoaiThanhToan == 1 ? "Tiền mặt" : hd.LoaiThanhToan == 2 ? "VNPay" : "Không xác định",
                         DaLayTien = hd.IsPayed == false ? "Chưa thanh toán" : "Đã thanh toán",
                     };
        ...
        public async Task<IActionResult> GetAllSanPham()
        {
            ...
            var list = _context.SanPhams.Select(
                   s => new SanPhamLoaiThuongHieu()
                   {
                       ...
                       TenNhaCungCap=_context.NhaCungCaps.Where(d=>d.Id==s.Id_NhaCungCap).Select(d=>d.Ten).FirstOrDefault(),
